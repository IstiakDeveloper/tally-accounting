...
Route::middleware('auth')->group(function () {
    ...
    Route::get('businesses/{business}/switch', [BusinessController::class, 'switch'])->name('businesses.switch');

    // Dashboard
    Route::middleware('business')->get('/dashboard', [DashboardController::class, 'index'])->name('dashboard');
    ...
    // Global Settings Routes (Admin Only) - Not business-specific
    Route::middleware('role:admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/businesses/{business}/users', [BusinessController::class, 'users'])->name('businesses.users');
        Route::post('/businesses/{business}/users', [BusinessController::class, 'attachUser'])->name('businesses.users.attach');
        Route::put('/businesses/{business}/users/{user}', [BusinessController::class, 'updateUserRole'])->name('businesses.users.update');
        Route::delete('/businesses/{business}/users/{user}', [BusinessController::class, 'detachUser'])->name('businesses.users.detach');
    });
});
