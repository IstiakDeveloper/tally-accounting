    ...
    <AppLayout title="Bank Accounts">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-2">
          <Link href={route('bank-accounts.create')} className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700">
                  ...
                  {bankAccounts.links.map((link, i) => (
                    <Link
                      ...
                      className={`relative inline-flex items-center px-4 py-2 text-sm font-medium ${
                        ...
                        i === bankAccounts.links.length - 1 ? 'rounded-r-md' : ''
                      } border`}
