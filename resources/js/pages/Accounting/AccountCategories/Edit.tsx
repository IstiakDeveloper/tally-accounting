...
interface AccountCategoriesEditProps {
...
export default function AccountCategoriesEdit({ category, types }: AccountCategoriesEditProps) {
  ...
  const handleSubmit = (e: FormEvent) => {
    e.preventDefault();
    put(route('account-categories.update', category.id));
  };

  return (
    <AppLayout title="Edit Account Category">
      <Head title="Edit Account Category - Tally Software" />
              ...
              <div>
                ...
                <div>
                  <select
                    ...
                    required
                    // Disable type change if category has accounts
                    disabled={category.accounts && category.accounts.length > 0}
                  >
                ...
                {category.accounts && category.accounts.length > 0 && (
                  <p className="mt-2 text-sm text-amber-600">
                    This category has accounts associated with it. The type cannot be changed.
                  </p>
                )}
