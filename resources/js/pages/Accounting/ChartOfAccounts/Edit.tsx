...
import { AccountCategory, ChartOfAccount } from '@/types';

interface ChartOfAccountsEditProps {
    account: ChartOfAccount;
    categories: AccountCategory[];
}

export default function ChartOfAccountsEdit({ account, categories }: ChartOfAccountsEditProps) {
    ...
    const [selectedCategory, setSelectedCategory] = useState<AccountCategory | null>(
        categories.find(c => c.id === account.category_id) || null
    );
    ...
    return (
        <AppLayout title="Edit Account">
            <Head title="Edit Account - Tally Software" />
                                ...
                                <div>
                                    ...
                                    <div>
                                        <input
                                            ...
                                            className={`h-10 px-4 py-2 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 block w-full text-sm border-gray-300 rounded-md ${errors.account_code ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : ''
                                                }`}
                            ...
                            <div>
                                ...
                                <div>
                                    <select
                                        ...
                                        className={`h-10 px-4 py-2 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 block w-full text-sm border-gray-300 rounded-md ${errors.category_id ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : ''
                                            }`}
                                        required
                                        // Disable if has journal entries
                                        disabled={account.journal_items && account.journal_items.length > 0}
                                    >
                                ...
                                {account.journal_items && account.journal_items.length > 0 && (
                                    <p className="mt-2 text-sm text-amber-600">
                                        This account has transactions. The category cannot be changed.
                                    </p>
                                )}
                                {selectedCategory && (
                            ...
                            <div>
                                ...
                                <div>
                                    <textarea
                                        ...
                                        rows={3}
                                        className={`px-4 py-2 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 block w-full text-sm border-gray-300 rounded-md ${errors.description ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : ''
                                            }`}
