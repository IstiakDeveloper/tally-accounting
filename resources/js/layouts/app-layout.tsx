...
export default function MainLayout({ children, title = 'Dashboard' }: MainLayoutProps) {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      submenu: [
        { label: 'Chart of Accounts', href: '/accounts', icon: <BookOpen size={18} /> },
        { label: 'Journal Entries', href: '/journals', icon: <FileText size={18} /> },
        { label: 'Financial Years', href: '/financial-years', icon: <Calendar size={18} /> },
        { label: 'Bank Accounts', href: '/bank-accounts', icon: <Building size={18} /> },
      ],
